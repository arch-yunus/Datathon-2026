...
commands = [
    ...
    # 2. Hyperparameter Tuning (Heavy tuning mode: 60 trials for CatBoost, LightGBM/XGBoost skipped using cached best_params)
    f"{sys.executable} src/tune_all.py --train train_fe.csv --out best_params.json --trials 60 --models catboost",
    ...
    f"{sys.executable} src/run_with_embeddings.py --train train.csv --test test_x.csv --out submission_embeddings.csv --model model_embeddings.pkl --cv 5 --model-name sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2",
