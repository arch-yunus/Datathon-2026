...
if __name__ == '__main__':
    ...
    parser.add_argument('--trials', type=int, default=10) # 10 for quick run
    ...
    lgb_params = tune_lightgbm(X, y, n_trials=args.trials)
    
    print(f"Tuning XGBoost for {args.trials} trials...")
    xgb_params = tune_xgboost(X, y, n_trials=args.trials)
    
    print(f"Tuning CatBoost for {args.trials} trials...")
    cat_params = tune_catboost(X, y, n_trials=args.trials)
